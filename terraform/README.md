...
1. VM / LXC コンテナ作成
2. k3s master / worker01,03〜07 インストール・クラスター参加
...
`null_resource.k3s_workers_install` (count=6) で worker01,03〜07 を統一管理。
...
- index 4/5 → `k3s_worker_node03[0/1]` (node03, worker_ips[5/6])
