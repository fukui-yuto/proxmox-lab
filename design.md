...
| VLAN ID | 用途 | サブネット |
|---------|------|-----------|
| 1 (native) | 管理ネットワーク (Proxmox Web UI / SSH / 既存 LAN と共存) | 192.168.210.0/24 |
| 10 | VM/コンテナ通信用 | 192.168.211.0/24 |
...
> NIC 1本でも Linux Bridge + VLAN サブインターフェース (`vmbr0.10`, `vmbr0.20`) により分離可能。
