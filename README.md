...
| 5 | Prometheus + Grafana をデプロイ | [k8s/monitoring/README.md](k8s/monitoring/README.md) |
...
└── k8s/
    ...
    └── monitoring/
        ├── README.md           # ★ Step 5: Prometheus + Grafana
        └── values.yaml
```
...
| k3s-worker02 | VM | 192.168.210.23 | k3s ワーカー (pve-node01) |
